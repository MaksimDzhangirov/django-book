...
Большинство Django приложений содержат `urls.py`, файлы с миграциями, и каталоги, такие как `templates`

и `static`.

Именно отсюда добавляются новые таблицы в нашу базу данных, когда мы изменяем `models.py`. Данные, созданные с помощью 
