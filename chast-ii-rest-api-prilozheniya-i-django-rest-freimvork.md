...
HTTP \(протокол передачи гипертекста\) - это структура для хранения "данных". Он находится в самом верхнем уровне - прикладном уровне. Он перемещается по Интернету с помощью транспортного уровня. 
