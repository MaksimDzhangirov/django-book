...
Большинство начинающих Django разработчиков пишут большинство представлений с нуля. О таком понятии как представления-классы они или не слышали \(да, это понятие не достаточно хорошо описано в документации, поэтому не все используют его с самого начала\) или боятся его использовать. Однако четкое определение что собой представляют представления-классы даётся на сайте [Classy Class-Based Views](https://ccbv.co.uk/):
